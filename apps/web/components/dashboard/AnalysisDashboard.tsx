...
import { Brain, Layers, Radar, Sparkles } from "lucide-react";
...
export function AnalysisDashboard({ 
  ...
  if (activeView === "map") {
    return (
      <div className="glass rounded-lg p-5 flex flex-col h-[calc(100vh-10rem)]">
  ...
  const currentProjectName = activeProjectId ? disasterEvents.find(e => e.id === activeProjectId)?.name : "Global Overview";

  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between glass rounded-xl p-5 border border-white/10 shadow-lg backdrop-blur-md">
        <div>
        ...
        <select 
          ...
          className="rounded-lg border border-white/10 bg-black/40 p-2 text-sm text-slate-200 outline-none focus:border-cyan/50 min-w-[250px] shadow-inner transition hover:border-white/20"
        >
      ...
      <section key={`top-${activeProjectId}`} className="grid gap-5 xl:grid-cols-[1.15fr_0.85fr]">
        <div className="glass rounded-xl p-6 border border-white/10 shadow-xl backdrop-blur-md">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-cyan/90 mb-1">Predictive analytics</p>
              <h2 className="text-xl font-bold text-white/90">Risk trajectories</h2>
            </div>
        ...
        <div className="glass rounded-xl p-6 border border-amber/20 shadow-[0_0_30px_rgba(245,158,11,0.05)] backdrop-blur-md relative overflow-hidden">
          ...
          <div className="mb-4 flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-white/90">AI insight panel</h2>
          </div>
          ...
          <div className="mb-4 flex flex-col gap-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h2 className="text-xl font-bold text-white/90">Live event map layers</h2>
              </div>
              <div className="grid h-8 w-8 place-items-center rounded bg-cyan/15">
        ...
        <div className="space-y-5">
          <div className="glass rounded-xl p-6 border border-white/10 shadow-xl backdrop-blur-md">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-white/90">Resource optimization</h2>
            </div>
          ...
          <div className="glass rounded-xl p-6 border border-white/10 shadow-xl backdrop-blur-md">
            <h2 className="mb-4 text-xl font-bold text-white/90">Digital twin</h2>
            <DigitalTwin />
          </div>
        </div>
      </section>
